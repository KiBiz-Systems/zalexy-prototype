...
var SHARED_SIDEBAR_HTML = `
  <aside class="sidebar">
    ...
    <nav class="nav" aria-label="Primary">
      ...
      <a class="nav-item" href="booking-flow.html"><span class="material-symbols-rounded">edit_calendar</span>Booking Flow (Staff)</a>
      <a class="nav-item" href="booking-flow.html?mode=client"><span class="material-symbols-rounded">person</span>Booking Flow (Client)</a>
